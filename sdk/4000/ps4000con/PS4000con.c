...
* History:
*
* 06Dec13 HSM - Modified streaming capture to copy data in callback
*			  - Updated Signal generator
*			  - updated to use stdint.h data types
*
*
***************************************************************************/
...
// Signal generator
#define	AWG_DAC_FREQUENCY_4000	20e6	// 20MS/s update rate
#define	AWG_DAC_FREQUENCY_4262	192e3	// 192kS/s update rate
...
* - PS4226 & 4227 - values 0..4095, up to 8192 samples int32_t
* - PS4262 - values -32768..32767, 4096 samples int32_t
******************************************************************************/
void SetSignalGenerator(UNIT_MODEL unit)
{
	...
	else																						
	{
		...
		UCVal = 1 / AWG_DAC_FREQUENCY_4000;			// 1/20MHz = 5e-8
